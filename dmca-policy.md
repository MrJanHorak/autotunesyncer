...
*Draft starting point — not legal advice. To actually claim DMCA safe-harbor protection under 17 U.S.C. § 512, you generally need to: (1) designate an agent and register them with the U.S. Copyright Office at https://dmca.copyright.gov/ (there's a filing fee), (2) post that agent's info publicly (this page), and (3) actually follow a notice-and-takedown + repeat-infringer process. A lawyer (or even just the Copyright Office's own guidance) can confirm you've done this correctly — it's a fairly mechanical process, not an expensive one.*
...
3. Identification of the material you claim is infringing, and information reasonably sufficient to let us locate it (e.g., a link, project ID, or username);
...
*(Register this agent at https://dmca.copyright.gov/ before relying on this page for safe harbor.)*
...
- Notify the user who uploaded it and provide them a copy of the notice;
- Track repeat notices against a given account (see Repeat Infringer Policy below).
...
4. Your name, address, telephone number, and a statement that you consent to the jurisdiction of the federal court in your district (or, if outside the U.S., an appropriate judicial district) and will accept service of process from the person who filed the original notice.

Send counter-notices to the same DMCA Agent address above. Absent a valid legal action from the original complainant, we may reinstate the material in 10–14 business days, as required by the DMCA.

## Repeat infringer policy

Accounts that receive multiple valid infringement notices will be suspended or terminated at our discretion, consistent with 17 U.S.C. § 512(i).

## Misrepresentation

Under Section 512(f) of the DMCA, any person who knowingly materially misrepresents that material is infringing, or was removed by mistake, may be liable for damages. Please make sure your notice is accurate before submitting it.
